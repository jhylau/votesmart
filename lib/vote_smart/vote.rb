module VoteSmart
  ...
  class Vote < Common
    ...
    # Gets a list of bills that fit the criteria
    def self.get_by_official can_id, year = nil
      request("Votes.getByOfficial", "candidateId" => can_id, "year" => year)
    end
    ...
    def self.get_bills_by_sponsor_category can_id, category_id
      request("Votes.getBillsBySponsorCategory", "candidateId" => can_id, "categoryId" => category_id)
    end
